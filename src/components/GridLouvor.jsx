...
export default function GridLouvor({ escalas, datas, loading, onRemover, podeEditar, filtroNome = "" }) {
                  ...
                  return (
                    ...
                    >
                      {pessoa ? (
                          ...
                          {podeEditar && (
                            <button
                              ...
                              style={{
                                ...
                                color: "var(--text)", fontSize: "9px", padding: "2px 1px 0 0",
                        ...
                        <span className="grid-louvor-empty-slot" style={{ color: "var(--text)", fontSize: "11px", opacity: dim ? 0.3 : 1 }}>—</span>
                      )}
                    </td>
                  );
                })}
